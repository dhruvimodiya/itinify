          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
              ...
              <ul className="text-sm text-blue-700 text-left space-y-1">
                ...
                <li>• You can only use the verification link once</li>
              </ul>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>Please check your spam/junk folder first. If you still can't find the verification email, enter your email below.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-travel-brown-500 focus:border-travel-brown-500 sm:text-sm"
            ...
            <div className="text-center space-y-2">
              <Link
                to="/login"
                className="text-sm text-travel-brown-600 hover:text-travel-brown-500 block"
              >
                Back to Login
              </Link>
              <Link
